...
def parse2(sam_path, chroms_path, output_file, assembly, min_mapq,
    ...
    '''
    parse2_py(sam_path, chroms_path, output_file, assembly, min_mapq,
             drop_readid, drop_seq, drop_sam, add_junction_index, add_columns,
             output_stats, coordinate_system, **kwargs)


def parse2_py(sam_path, chroms_path, output_file, assembly, min_mapq,
             drop_readid, drop_seq, drop_sam, add_junction_index, add_columns,
             output_stats, coordinate_system, **kwargs):
    ...
    outstream = (_fileio.auto_open(output_file, mode='w',
