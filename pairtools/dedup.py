...
@click.option(
    ...
    type=str, 
    default="", 
    help='output .pairs/.pairsam file containing de-duplicated pairs.'
...
@click.option(
    ...
    type=str, 
    default="", 
    help='output .pairs/.pairsam file containing duplicates. '
        ' If the path ends with .gz, the output is bgzip-compressed.'
...
def dedup(pairs_path, output, output_dups,
    stats_file,
    max_mismatch, method, 
    ...
    is read from stdin.
    '''
    dedup_py(pairs_path, output, output_dups,
        stats_file,
        max_mismatch, method, 
        sep, comment_char, send_header_to,
        c1, c2, p1, p2, s1, s2
...
def dedup_py(pairs_path, output, output_dups,
    stats_file,
    max_mismatch, method, 
    sep, comment_char, send_header_to,
    c1, c2, p1, p2, s1, s2
